...
from ccdl.utils import win_char_replace
import json
import logging
import os
import re
...
from .utils import (ComicLinkInfo, ComicReader, ProgressBar, RqHeaders, RqProxy,
                    SiteReaderLoader, cc_mkdir, downld_url, win_char_replace, write2file)
...
class Ganganonline(ComicReader):
    ...
    def downloader(self):
        ...
        if r.status_code != 200:
            logger.error("http code: {} ;ganganonline: {}".format(
