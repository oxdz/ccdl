...
from .utils import ComicLinkInfo, ComicReader, ProgressBar, SiteReaderLoader, cc_mkdir, downld_url, win_char_replace
...
class SundayWebry(ComicReader):
    def __init__(self, linkinfo: ComicLinkInfo, driver: webdriver.Chrome = None) -> None:
        super().__init__()
    ...
    def downloader(self):
        ...
        file_path = "./漫畫/" + \
            win_char_replace(self._driver.find_element_by_css_selector(
                'div.header-wrapper-label').text)
