...
class Ganma(ComicReader):
    ...
    def manga_info(self):
        rq = requests.get(
            url="https://ganma.jp/api/2.0/magazines/" + self._manga_alias,
        ...
        if "success" in resp and resp["success"]:
            ...
            mangainfo["index_title"] = [x["title"] for x in mangainfo["items"]]
    ...
    def login(self, mail, passwd):
        ...
        rq = requests.post(
            ...
            json={"password": passwd, "mail": mail},
    ...
    def logout(self):
        rq = requests.delete(
            url="https://ganma.jp/api/1.0/session",
